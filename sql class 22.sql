...
select e.name,d.department_name from departments d inner join employees e
 ...
 select  count(employee_id) as total_employee ,year(hire_date) as hire_year from departments d inner join 
 employees e on d.department_id=e.department_id group by year(hire_date);
 
  select  count(employee_id) as total_employee ,monthname(hire_date) as hire_year from departments d inner join 
 employees e on d.department_id=e.department_id group by monthname(hire_date);
 
 select  count(*) as empl_count ,year(hire_date) as hire_year from employees group by year(hire_date);
 
 #14 count employess grouped by departments and hiredate
 select  d.department_name,count(employee_id) as total_count,year(hire_date) as hire_date  from departments d inner join 
 employees e on d.department_id=e.department_id group by department_name,year(hire_date);
 ...
 select e.name,d.department_name,e.salary from departments d inner join employees e using(department_id) order by salary desc;
